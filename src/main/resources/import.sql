...
INSERT INTO rating_reference (rating) VALUES ('A');
INSERT INTO rating_reference (rating) VALUES ('AB');
INSERT INTO rating_reference (rating) VALUES ('B');
INSERT INTO rating_reference (rating) VALUES ('BC');
INSERT INTO rating_reference (rating) VALUES ('C');
INSERT INTO rating_reference (rating) VALUES ('D');
INSERT INTO rating_reference (rating) VALUES ('E');

INSERT INTO strength_improvement_reference (category, criteria) VALUES('Learner-centred teaching enables all learners to achieve', 'Learning strategies cater for the needs of the learners');``
INSERT INTO strength_improvement_reference (category, criteria) VALUES('Learner-centred teaching enables all learners to achieve', 'Learning activities are varied and interesting');``
INSERT INTO strength_improvement_reference (category, criteria) VALUES('Learner-centred teaching enables all learners to achieve', 'Learning time is managed effectively');``
INSERT INTO strength_improvement_reference (category, criteria) VALUES('Learner-centred teaching enables all learners to achieve', 'Questioning techniques progress learning');``
INSERT INTO strength_improvement_reference (category, criteria) VALUES('Learning environments ensure participation and engagement', 'Learning environment is positive and respectful');``
INSERT INTO strength_improvement_reference (category, criteria) VALUES('Learning environments ensure participation and engagement', 'Instructions, explanations and expectations are clear');``
INSERT INTO strength_improvement_reference (category, criteria) VALUES('Learning environments ensure participation and engagement', 'Learning environment is well organised');``
INSERT INTO strength_improvement_reference (category, criteria) VALUES('Learning environments ensure participation and engagement', 'Variety of interactive and independent activity');``
INSERT INTO strength_improvement_reference (category, criteria) VALUES('Learning environments ensure participation and engagement', 'Good use of learning technologies');``
